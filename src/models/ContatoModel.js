...
Contato.bucaPorId = async function(id){
...
Contato.prototype.valida = function () {
    ...
    if (!this.body.email && !this.body.telefone) this.erros.push('Telefone ou Email obrigatório')
};
...
Contato.bucaContatos = async function(){
